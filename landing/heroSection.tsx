      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-gray-100 border-l-4 border-[#1e4d8f] p-4 rounded-md text-sm text-gray-700 leading-relaxed">
            समस्त आदरणीय अधिवक्ता साथियों से विनम्र निवेदन है कि मैं,{" "}
            <span className="text-[#1e4d8f] font-bold">
              विवेक शर्मा (एडवोकेट)
            </span>
            , बार काउंसिल ऑफ राजस्थान के आगामी चुनाव में सदस्य पद हेतु प्रत्याशी
            हूँ।{" "}
            <span className="text-[#1e4d8f] font-bold">
              मेरा बैलेट नम्बर 192
            </span>{" "}
            है। आप सभी से निवेदन है कि अपना प्रथम / उच्च वरीयता का वोट एवं
            समर्थन देकर मुझे विजयी बनाने की कृपा करें, मैं आपका सदैव आभारी
            रहूँगा।
          </div>
          ...
          <div className="bg-white shadow-md rounded-md p-4 text-sm space-y-2 border-t-4 border-[#6b3f1d]">
            ...
            <p>
              <strong>📍 मतदान केंद्र:</strong> <br /> जयपुर (हाईकोर्ट) • जयपुर
              (सिविल कोर्ट) • जोधपुर • रायसिंहनगर (श्री गंगानगर)
            </p>
          </div>
